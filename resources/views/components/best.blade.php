    ...
    <div class="best__wrapper">
      <div class="best__item">
        ...
        <div class="best__item-text">
          <h3 class="jost">Регулятор <br> для ремня</h3>
        </div>
      </div>
      <div class="best__item">
        <img src="{{ Vite::asset('resources/images/best2.png') }}">
        <div class="best__item-text">
          <h3 class="jost">Съемная <br> металическая <br> пряжка</h3>
        </div>
      </div>
      <div class="best__item">
        <img src="{{ Vite::asset('resources/images/best3.png') }}">
        <div class="best__item-text">
          <h3 class="jost">Двухстороняя<br> металическая<br> молния</h3>
        </div>
      </div>
      <div class="best__item">
