...
<div class="card-body">
  <form method="POST" action="{{ route('admin.color.store') }}">
        ...
        <div class="col-sm-12 row mb-4">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" value="{{old('code') ?? '#000'}}" id="code" name="code" class="form-control" placeholder="Код цвета в формате hex">
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" name="title" class="form-control" placeholder="Название цвета" id="title">
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="row col-sm-12 input-group">
                ...
                <input type="text" class="form-control" id="main_image" name="main_image" value="{{ old('main_image') }}">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="row col-sm-12 input-group">
                  ...
                  <input type="text" class="form-control" id="image1" name="image1" value="{{ old('image1') }}">
                  <div class="input-group-prepend">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="row col-sm-12 input-group">
                  ...
                  <input type="text" class="form-control" id="image2" name="image2" value="{{ old('image2') }}">
                  <div class="input-group-prepend">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="row col-sm-12 input-group">
                  ...
                  <input type="text" class="form-control" id="image3" name="image3" value="{{ old('image3') }}">
                  <div class="input-group-prepend">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <div class="row col-sm-12 input-group">
                  ...
                  <input type="text" class="form-control" id="image4" name="image4" value="{{ old('image4') }}">
                  <div class="input-group-prepend">
    ...
    <div class="row col-sm-12 mt-2">      
      <div class="col-sm-12">
        <button class="btn btn-success" type="submit">Добавить цвет</button>
      </div>    
    </div>
  </form>
</div>
