...
<div class="card-body">
  <form method="POST" action="{{ route('admin.hero.store') }}">
    @csrf
    <div class="cart-body">
      <div class="row">
        <div class="col-sm-12 row mb-4">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" name="pos" value="{{old('pos')}}" class="form-control" placeholder="Должность">
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
    ...
    <div class="row col-sm-12 mt-2">      
      <div class="col-sm-12">
        <button class="btn btn-success" type="submit">Добавить героя</button>
      </div>    
    </div>
  </form>
</div>
